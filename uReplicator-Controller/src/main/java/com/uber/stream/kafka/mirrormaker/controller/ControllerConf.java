...
public class ControllerConf extends PropertiesConfiguration {
    ...
    private static final String SOURCE_DATA_CENTER_TAG = "controller.source.datacenter";
    ...
    public String getSourceDataCenterTag() {
        return (String) getProperty(SOURCE_DATA_CENTER_TAG);
    }

    public void setSourceDataCenterTag(String sourceDataCenterTag) {
        setProperty(SOURCE_DATA_CENTER_TAG, sourceDataCenterTag);
    }
    ...
    public static Options constructControllerOptions() {
        ...
        controllerOptions.addOption("help", false, "Help")
                ...
                .addOption("sourceDataCenterTag", true, "Data center tag/id that will be used to filter out source kafka topics.")
    ...
    public static ControllerConf getControllerConf(CommandLine cmd) {
        ...
        if (cmd.hasOption("sourceDataCenterTag")) {
            controllerConf.setSourceDataCenterTag(cmd.getOptionValue("sourceDataCenterTag"));
        }
        ...
        if (cmd.hasOption("sourceDataCenter")) {
            controllerConf.setSourceDataCenterTag(cmd.getOptionValue("sourceDataCenter"));
        }
